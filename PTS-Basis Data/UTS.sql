1. SELECT * FROM tb_obat satuan='Botol';
...
13. SELECT nama_obat, stok, harga_beli, harga_jual, (harga_beli *stok) AS totalhargabeli, (harga_jual *stok) AS totalhargajual FROM tb_obat;
